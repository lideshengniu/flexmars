<template>
  ...
  <teleport to="body" v-if="Test.shili">
    <shili></shili>
  </teleport>
  <teleport to="body" v-if="Test.gys">
    <imgee></imgee>
  </teleport>

  <a-table :scroll="tableHeight" :columns="columns" :dataSource="data" size="middle"
    style="background-color: skyblue; color: red !important" :pagination="{ pageSize: 3 }" :width="8" class="tables">
